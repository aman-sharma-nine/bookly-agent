...
After issue_refund: if success=false and status="rejected", explain the tool's customer-safe rejection and stop — do not retry and do not call escalate_case. If status="requires_review", call escalate_case and explain that human review is required. Never claim a refund succeeded unless the tool confirms success. Do not add optional escalation behavior for this demo.
